/**
 * Geofencing utility for Kanjirapally Panchayath, Kottayam District, Kerala, India (Backend)
 * 
 ...
 */
function isWithinKanjirapally(latitude, longitude) {
  ...
  if (
    ...
    return {
      isInside: false,
      message: 'Location is outside Kanjirapally panchayath. This service is only available for residents within Kanjirapally panchayath area.'
    };
  }
  ...
  return {
    isInside,
    message: isInside 
      ? 'Location verified within Kanjirapally panchayath.'
      : 'Location is outside Kanjirapally panchayath. This service is only available for residents within Kanjirapally panchayath area.'
  };
}
 ...
 */
function getKanjirapallyCentre() {
  return {
...
const isWithinKottayam = isWithinKanjirapally;
const getKottayamCenter = getKanjirapallyCentre;
 ...
 */
function getKanjirappallyBoundary() {
  return [...KANJIRAPALLY_BOUNDARY];
}

// Backward compatibility
const getKottayamBoundary = getKanjirappallyBoundary;
