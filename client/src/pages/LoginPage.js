...
import { FiEye, FiEyeOff, FiMail, FiLock, FiMapPin, FiUsers, FiShield, FiTrendingUp } from 'react-icons/fi';
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-100 via-blue-50 to-purple-50">
        ...
        <div className="absolute inset-0">
          <FaCity className="absolute top-20 left-20 text-primary-200 w-8 h-8 animate-pulse" />
          <FiMapPin className="absolute top-32 right-32 text-blue-200 w-6 h-6 animate-bounce" />
          <FaCog className="absolute bottom-40 left-16 text-purple-200 w-7 h-7 animate-spin" style={{ animationDuration: '8s' }} />
          <FaBuilding className="absolute top-40 left-1/2 text-indigo-200 w-6 h-6 animate-pulse" />
          <FiShield className="absolute bottom-32 right-20 text-green-200 w-6 h-6 animate-bounce" />
        </div>
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-8">
        ...
        >
            ...
            >
              ...
              <div className="text-center">
                <motion.div
                  ...
                  className="mx-auto w-16 h-16 bg-gradient-to-r from-primary-600 to-blue-600 rounded-2xl flex items-center justify-center mb-4 shadow-lg"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                ...
                <div>
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-100 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:bg-white transition-all duration-200"
                    placeholder="Email"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-primary-600 to-blue-600 hover:from-primary-700 hover:to-blue-700 text-white font-semibold py-2.5 sm:py-3 px-4 rounded-full transition-all duration-200 flex items-center justify-center shadow-lg"
                >
                  {isLoading ? (
                    <>
                      <InlineSpinner />
          ...
          {/* Right Side - Smart City Themed Welcome Section */}
          <div className="bg-gradient-to-br from-primary-500 via-primary-600 to-blue-700 flex items-center justify-center p-6 sm:p-8 lg:p-12 relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <FaCog className="w-20 h-20 animate-spin" style={{ animationDuration: '20s' }} />
              </div>
            </div>
            ...
            >
              ...
              >
                <Link
                  to="/register"
                  className="inline-block px-8 py-3 border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-primary-600 transition-all duration-300"
                >
                  JOIN NOW
                </Link>
              </motion.div>
